      ...
      <Container>
        <div className="mx-auto flex justify-between items-center border-b border-[#f4f4f4] py-1">
          <div className="flex items-center space-x-6">
            <Dropdown id="currency" items={currencyOptions} selected={currencyOptions.find(el => el.id == selected_currencies_id.toString())} style="px-0" />
            <Dropdown id="langauges" items={languageOptions} selected={languageOptions.find(el => el.id == selected_language_id.toString())} style="px-0"/>
          </div>
