...
const textOverlayStyles =
  'absolute flex text-[11px] font-extralight items-center justify-center !z-[-1] bg-primary text-white invisible opacity-0 translate-x-[5px] top-0 bottom-0 right-4 rounded-tl-[30px] rounded-bl-[30px] w-[110px] group-hover/cart:opacity-100 group-hover/cart:visible group-hover/cart:translate-x-0 transition-all duration-[0.35s] ease';
