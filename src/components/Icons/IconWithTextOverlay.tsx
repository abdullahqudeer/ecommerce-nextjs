...
export const baseIconStyles =
  'flex w-[30px] h-[30px] items-center justify-center rounded-full bg-white text-primary group-hover/cart:bg-primary group-hover/cart:text-white transition-all duration-[0.35s] ease';
