...
const methods = [
  ...
  // },
  {
    ...
    text: "our credit card information is not stored in our database for your security. Your payment transactions are carried out securely, protected by an SSL certificate.",
  },
];
        ...
        <div key={index}>
          ...
          <div className="overflow-hidden pl-6 py-1">
            <Collapse isOpen={selectedMethod === index}>
              <p className="text-xs font-extralight text-black-200 leading-[20.04px]">
                {method.text}
              </p>
            </Collapse>
          </div>
